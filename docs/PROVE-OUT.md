...
|---|---|---|---|---|
| **ODESC 3.6** (dual-drive, 56 V) | 1 | ~$55–70 | [Sequre](https://sequremall.com/products/odesc-dual-drive) · [AliExpress](https://www.aliexpress.com/item/1005007734783069.html) · [Amazon](https://www.amazon.com/Optimizes-Brushless-High-power-Dual-drive-Controller/dp/B09KNKX8K5) | Drop-in for the obsolete ODrive v3.6; runs the firmware the repo code targets. See `BOM.md`. |
